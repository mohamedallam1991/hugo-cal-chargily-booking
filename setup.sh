...
# Hugo Cal.com Booking Module Setup Script
...
show_help() {
    echo "Hugo Cal.com Booking Module Setup"
    echo ""
...
print_status "Setting up Hugo Cal.com Booking Module for: $SITE_NAME"
...
---
title: "Welcome to Hugo Cal.com Booking Module"
---
...
See the [module documentation](https://github.com/mohamedallam1991/hugo-cal-booking) for more details.
EOF
...
print_status "2. Customize styling as needed"
print_status "3. Test booking functionality"
print_status ""
